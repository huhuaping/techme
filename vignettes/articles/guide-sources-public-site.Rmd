...
1. 科技部开放共享评估结果，数据集`techme::PubOpenShare`。已获得：html文件、pdf文件、xlsx文件（pdf转xlsx）。后续重要工作：使用天眼查机构名称。

## 待检查数据来源

1. 国家科技成果转移转化示范区评估验收。关于吉林长吉图国家科技成果转移转化示范区评估验收结果，[参看](https://www.most.gov.cn/xxgk/xinxifenlei/fdzdgknr/qtwj/qtwj2025/202511/t20251104_195126.html)。需要检查数据来源。
