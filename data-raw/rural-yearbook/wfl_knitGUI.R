...
dir_final <- c(
  "00-firms", "01-employee", "03-spend-inner", "04-spend-outer",
...
source(here("data-raw/wfl_unlock.R"))

# =====step 5: edit xlsx files manually =====
source(here("data-raw/wfl_editXls.R"))
Sys.sleep(1)
...
source(here("data-raw/wfl_unpivot_livestock.R"), encoding = "UTF-8")
