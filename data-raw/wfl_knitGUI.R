...
pattern_sel <- "^raw-2022-2023-unlocked.xlsx$"
...
# rpl <- c("有研发机�?, "有RD活动")
# ptn <- c("地方一般公共预算支�?,"教育支出","科学技术支�?,"农林水支�?)
# rpl <- c("合计","教育","科学技�?,"农林�?)
# ptn <- c("项目�?,"新产品开发项目数","新产品开发经费支�?,"新产品销售收�?,"有效发明专利�?)
# rpl <- c("项目数量","开发项目数","开发经费支�?,"销售收�?,"有效专利�?)
# ptn <- c("营业收入")
# rpl <- c("主营业务收入")
# ptn <- c("进出口贸易总额")
# rpl <- c("贸易总额")
